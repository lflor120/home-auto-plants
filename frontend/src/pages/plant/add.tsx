...
const PlantForm = () => {
    const [plantData, setPlantData] = useState<PlantCreate>({
        plantName: '',
        plantType: '',
        interval: null,
        frequency: '',
    ...
    async function postPlant(plant: PlantCreate): Promise<PlantCreate> {
        try {
            ...
            const data: PlantCreate = await response.json();
            return data;
